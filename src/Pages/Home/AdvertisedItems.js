...
const AdvertisedItems = () => { 
    ...
    const {data: advertisedProdcuts = [], isLoading} = useQuery({
        queryKey: ['advertisedProdcuts'],
        queryFn: async() => {
            const res = await fetch(`https://bike-re-sale-server.vercel.app/advertised-products`)
